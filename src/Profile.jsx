    ...
    <header className="my-10 mx-auto text-white">
      <div className="flex gap-3">
        ...
        <div className="flex flex-col w-2/3 justify-around">
          <div>
            <h1 className="text-2xl font-black tracking-wide">Jerson Dela Cerna</h1>
            <h3 className="text-sm ml-[.04rem]">A self-taught web developer.</h3>
          </div>
          <div className="flex gap-2 ml-[.04rem] text-xs">
